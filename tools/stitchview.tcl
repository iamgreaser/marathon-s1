...
set ::layout_boxes {
   ...
   {LVLAYOUT_GHZ2 0x0001 0x0C60 0x0001 0x0340 0 8}
   {LVLAYOUT_GHZ3 0x0001 0x0A00 0x00E8 0x0340 -16 0}
   {LVLAYOUT_BRI1 0x0001 0x1E00 0x0001 0x0140 -6 -8}
   {LVLAYOUT_BRI2 0x0001 0x0F00 0x0001 0x0340 -8 -18}
   ...
   {LVLAYOUT_LAB3 0x0001 0x0580 0x0001 0x0740 0 -25}
   {LVLAYOUT_SCR1 0x0001 0x1DA0 0x0001 0x0120 -7 13}
   {LVLAYOUT_SCR2_main 0x0001 0x0F00 0x0001 0x0340 -10 -14}
   {LVLAYOUT_SCR2_upper 0x0001 0x0700 0x0001 0x0740 -4 -58}
   {LVLAYOUT_SCR2_lower 0x0001 0x0300 0x0001 0x0AA0 -64 82}
   {LVLAYOUT_SCR3 0x0001 0x0700 0x0220 0x0740 31 -106}
   {LVLAYOUT_SKY1 0x0001 0x0F00 0x0001 0x0340 -18 -44}
   {LVLAYOUT_SKY2 0x0001 0x0700 0x0001 0x0640 -24 -20}
   {LVLAYOUT_SKY3_endof_SKY2 0x0001 0x0700 0x0001 0x0340 16 0}
}
# Special stages
